...
import { setCache, getCache, fromCache } from "@/lib/cache";
import { getMnemonic } from "@/lib/bip44";
...
import { getAccount, getTxHistory } from "@/sdk";
import BigNumber from "bignumber.js";
import { ethTxToTx, PendingTx, TonMsg, tonTxToTx, Tx } from "@/models/tx";
import { Wallet } from "@/models/wallet";
import { useEthereum } from "@/hooks/use-ethereum";
import { defaultNetworks, defaultTonNetwork } from "@/lib/constants";
import { NewWallet } from "@/sdk/ton-node-api";
import { derivePublicKey } from "@/sdk/ton-js-client/importWallet";
import { useERC20 } from "@/hooks/use-erc20";
import { usePrices } from "@/hooks/use-prices";
import { getProvider } from "@/sdk/web3/client";
import { uniqBy } from "lodash";
import { usePin } from "@/hooks/use-pin";
import { deployWallet } from "@/sdk/ton-js-client/newWallet";
import { grant } from "@/sdk/ton-js-client/grant";
...
const actions = defineActions({
  ...
  async grantTONWallet(
    ...
    if (wallet.network.protocol !== "ton") {
      handleError({}, "not a TON wallet");
      return;
    }
    if (!wallet.network.giverAddress) {
      handleError({}, "Not available for this TON network");
      return;
    }
